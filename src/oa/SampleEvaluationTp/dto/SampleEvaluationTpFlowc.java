...
public class SampleEvaluationTpFlowc implements Cloneable, Serializable {
	...
	public String toString() {
		...
		out.append("\nclass SampleEvaluationTpFlowc, mapping to table SAMPLE_EVALUATION_TP_FLOWC\n");
	...
	public Object clone() {
		SampleEvaluationTpFlowc cloned = new SampleEvaluationTpFlowc();
