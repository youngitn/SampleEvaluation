...
public class SampleEvaluationSubFlowcBaseDto implements Cloneable, Serializable {
	...
	public SampleEvaluationSubFlowcBaseDto() {

	}

	public SampleEvaluationSubFlowcBaseDto(String ownPnoIn) {
	...
	public boolean hasEqualMapping(SampleEvaluationSubFlowcBaseDto valueObject) {
	...
	public Object clone() {
		SampleEvaluationSubFlowcBaseDto cloned = new SampleEvaluationSubFlowcBaseDto();
