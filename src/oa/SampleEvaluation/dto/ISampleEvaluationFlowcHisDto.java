...
public interface ISampleEvaluationFlowcHisDto<E> {
	...
	void setAll(String ownPnoIn, String F_INP_STATIn, String F_INP_TIMEIn, String F_INP_IDIn, String F_INP_INFOIn);
