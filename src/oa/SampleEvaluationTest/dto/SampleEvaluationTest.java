...
public class SampleEvaluationTest extends SampleEvaluationSubBaseDto implements Serializable {
	...
	public SampleEvaluationTest(String[] strings) {
		super(strings);
	}

	public SampleEvaluationTest() {
